...
import {
  Eye, Star, ThumbsUp, Repeat, TrendingUp, MessageSquare,
  AlertCircle, Search, Calendar, Instagram, ExternalLink, Lightbulb
} from 'lucide-react';
...
export function SocialVisibilityDashboard() {
  ...
  const modals = {
    'reply-reviews': {
      ...
      content: 'Respond to your recent negative reviews to improve customer sentiment and show you care.',
      suggestedText: 'Thank you for your feedback! We apologize for the wait time and are working to improve our service. We\'d love another chance to serve you better.',
      suggestedHashtags: [],
    },
    'post-instagram': {
      title: 'Post on Instagram',
      content: 'Share engaging content to boost your social media presence and reach.',
      suggestedText: 'Join us for our famous Spicy Noodle Challenge! 🌶️ Tag us in your food adventures!',
      suggestedHashtags: ['#SpicyNoodles', '#FoodieChallenge', '#LocalEats', '#ThaiFood'],
    },
    'update-keywords': {
      title: 'Update Keywords',
      content: 'Add trending keywords to your menu description to improve search visibility.',
      suggestedText: 'Our signature Spicy Noodles are a local favorite! Try our authentic Thai cuisine with bold flavors.',
    ...
    <div className="min-h-screen bg-bs-neutral-100 pb-20">
      ...
      <div className="bg-white border-b border-bs-neutral-200 sticky top-0 z-10 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6">
          ...
          <p className="text-bs-neutral-600">
            Understand your traffic, visibility, and brand awareness with actionable insights
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 space-y-8">
        ...
        <section aria-labelledby="summary-metrics">
          <h2 id="summary-metrics" className="mb-4">Top Summary Metrics</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="bg-white rounded-lg border-2 border-bs-neutral-200 p-6">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-2xl font-bold text-bs-neutral-900">72/100</span>
              </div>
            ...
            <div className="bg-white rounded-lg border-2 border-bs-neutral-200 p-6">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-2xl font-bold text-bs-neutral-900">4.6</span>
              </div>
            ...
            <div className="bg-white rounded-lg border-2 border-bs-neutral-200 p-6">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-2xl font-bold text-bs-neutral-900">3.8%</span>
              </div>
              <h3 className="text-sm text-bs-neutral-600">Social Engagement Rate</h3>
            ...
            <div className="bg-white rounded-lg border-2 border-bs-neutral-200 p-6">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-2xl font-bold text-bs-neutral-900">68%</span>
              </div>
        ...
        <section aria-labelledby="traffic-funnel">
          <h2 id="traffic-funnel" className="mb-4">Traffic & Conversion Funnel</h2>
        ...
        <section aria-labelledby="social-visibility">
          <h2 id="social-visibility" className="mb-4">Social Media Visibility</h2>
          ...
          <div className="bg-white rounded-lg border-2 border-bs-neutral-200 p-6 mt-4">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="font-bold text-bs-neutral-900">Trending Keywords</h3>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3">
              {trendingKeywords.map((item, index) => (
                <div key={index} className="p-3 bg-bs-green/5 border border-bs-green/20 rounded-lg">
                  <div className="font-medium text-bs-neutral-900 text-sm">{item.keyword}</div>
        ...
        <section aria-labelledby="sentiment-awareness">
          <h2 id="sentiment-awareness" className="mb-4">Customer Sentiment & Awareness</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-4">
            ...
            <div className="bg-white rounded-lg border-2 border-bs-neutral-200 p-6">
              ...
              <ResponsiveContainer width="100%" height={200}>
                <BarChart data={complaintThemes}>
                  ...
                  <YAxis stroke="#737373" />
                  <Tooltip />
                  <Bar key="count" dataKey="count" fill="#FF4C4C" radius={[8, 8, 0, 0]} />
                </BarChart>
              </ResponsiveContainer>
              <div className="mt-4 text-sm text-bs-neutral-600">
                Most common issue: <span className="font-bold text-bs-red">Wait Time (12 mentions)</span>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg border-2 border-bs-neutral-200 p-6 lg:col-span-2">
              ...
              <div className="flex items-center justify-between">
                <div>
                  <div className="text-4xl font-bold text-bs-neutral-900">64%</div>
                  <div className="text-sm text-bs-neutral-600 mt-1">of local customers recognize your brand</div>
                </div>
                <div className="text-right">
                  <div className="text-bs-green text-sm font-medium">↑ 8% vs. last quarter</div>
                  <div className="text-xs text-bs-neutral-500 mt-1">Target: 75% by Q3</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <section aria-labelledby="seo-growth">
          <h2 id="seo-growth" className="mb-4">SEO & Long-Term Growth</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
            ...
            <div className="bg-white rounded-lg border-2 border-bs-neutral-200 p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="font-bold text-bs-neutral-900">Local Search Rank</h3>
              </div>
              <div className="text-center">
                <div className="text-4xl font-bold text-bs-neutral-900">#7</div>
                <div className="text-sm text-bs-neutral-600 mt-2">for "best Thai food near me"</div>
                <div className="text-xs text-bs-red mt-1">↓ 2 positions vs. last week</div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg border-2 border-bs-neutral-200 p-6">
              <div className="flex items-center gap-3 mb-4">
                <TrendingUp className="text-bs-green" size={24} />
                <h3 className="font-bold text-bs-neutral-900">Keyword Match Rate</h3>
              </div>
              <div className="text-center">
                <div className="text-4xl font-bold text-bs-neutral-900">62%</div>
                <div className="text-sm text-bs-neutral-600 mt-2">menu aligned with trending searches</div>
            ...
            <div className="bg-white rounded-lg border-2 border-bs-neutral-200 p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="font-bold text-bs-neutral-900">Content Freshness</h3>
              </div>
              <ResponsiveContainer width="100%" height={100}>
                <BarChart data={freshnessData}>
                  <XAxis dataKey="week" stroke="#737373" style={{ fontSize: '10px' }} />
                  <Tooltip />
                  <Bar key="posts" dataKey="posts" fill="#FFD700" radius={[4, 4, 0, 0]} />
                </BarChart>
              </ResponsiveContainer>
        ...
        <section aria-labelledby="action-center">
          <h2 id="action-center" className="mb-4">Action Center</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-lg border-2 border-bs-red p-6">
              ...
              <div className="space-y-3">
                <div className="p-3 bg-bs-red/5 border border-bs-red/20 rounded-lg">
                  <div className="font-medium text-bs-neutral-900">Low Instagram engagement</div>
                  <div className="text-sm text-bs-neutral-600 mt-1">Impact: High</div>
                </div>
                <div className="p-3 bg-bs-red/5 border border-bs-red/20 rounded-lg">
                  <div className="font-medium text-bs-neutral-900">Negative Google reviews trending</div>
                  <div className="text-sm text-bs-neutral-600 mt-1">Impact: High</div>
                </div>
                <div className="p-3 bg-bs-gold/5 border border-bs-gold/20 rounded-lg">
                  <div className="font-medium text-bs-neutral-900">Keyword mismatch</div>
                  <div className="text-sm text-bs-neutral-600 mt-1">Impact: Medium</div>
                </div>
              </div>
            ...
            <div className="bg-bs-blue/5 border-2 border-bs-blue rounded-lg p-6">
              ...
              <div className="space-y-4">
                <div>
                  <div className="font-medium text-bs-neutral-900 text-sm mb-1">Google Reviews</div>
                  <div className="text-sm text-bs-neutral-700">
                    Encourage customers to leave reviews with a QR code at checkout
                  </div>
                </div>
                <div>
                  <div className="font-medium text-bs-neutral-900 text-sm mb-1">Instagram</div>
                  <div className="text-sm text-bs-neutral-700">
                    Post 2 TikTok videos this week to improve engagement
                  </div>
                </div>
                <div>
                  <div className="font-medium text-bs-neutral-900 text-sm mb-1">TikTok</div>
                  <div className="text-sm text-bs-neutral-700">
                    Share behind-the-scenes cooking content to build authenticity
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg border-2 border-bs-neutral-200 p-6">
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between p-3 bg-bs-red/5 border border-bs-red/20 rounded-lg">
                  <span className="text-sm font-medium text-bs-neutral-900">Encourage reviews</span>
                  <span className="text-xs font-bold text-bs-red px-2 py-1 bg-bs-red/10 rounded-full">High</span>
                </div>
                <div className="flex items-center justify-between p-3 bg-bs-gold/5 border border-bs-gold/20 rounded-lg">
                  <span className="text-sm font-medium text-bs-neutral-900">Update keywords</span>
                  <span className="text-xs font-bold text-bs-gold px-2 py-1 bg-bs-gold/10 rounded-full">Medium</span>
                </div>
                <div className="flex items-center justify-between p-3 bg-bs-green/5 border border-bs-green/20 rounded-lg">
                  <span className="text-sm font-medium text-bs-neutral-900">Post extra content</span>
                  <span className="text-xs font-bold text-bs-green px-2 py-1 bg-bs-green/10 rounded-full">Low</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <section aria-labelledby="promotion-suggestions">
          <h2 id="promotion-suggestions" className="mb-4">Promotion Suggestions</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="bg-gradient-to-br from-bs-gold/10 to-bs-gold/5 border-2 border-bs-gold rounded-lg p-6">
              <div className="flex items-center gap-2 mb-3">
                ...
                <h3 className="font-bold text-bs-neutral-900">Family Dinner Friday</h3>
              </div>
            ...
            <div className="bg-gradient-to-br from-bs-red/10 to-bs-red/5 border-2 border-bs-red rounded-lg p-6">
              ...
              <p className="text-sm text-bs-neutral-700 mb-4">
                Add "Spicy Noodles" to your menu description to match trending searches.
              </p>
              <button
                onClick={() => handleQuickFix('update-keywords')}
      ...
      {selectedModal && modals[selectedModal as keyof typeof modals] && (
        <ActionModal
          ...
          suggestedText={modals[selectedModal as keyof typeof modals].suggestedText}
          suggestedHashtags={modals[selectedModal as keyof typeof modals].suggestedHashtags}
        />
      )}
    </div>
  );
